...
<form class=id="sessionMessageForm">
    <h3>
...
<c:if test="${sessionScope.role != null}">
    ...
    <div>
        <c:if test="${not empty requestScope.pageable.elements}">
            <table class="table">
                <thead class="light shown-thread-products">
                <tr>
                    <th></th>
